...
Official OpenAPI 3.0 specification for LastPass API integration with Rewst.
...
- **Version**: v2-curated
- **Base URL**: `https://provisioning.lastpass.com/scim/v2`
- **Authentication**: BearerAuth

## Description
SCIM 2.0 endpoints for provisioning LastPass users and groups. Auth via Bearer token.
